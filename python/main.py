...
def V1():
    ...
    measurments_file_path = os.path.realpath(
        os.path.join(
...
# Mostly the same as V1 but with some easy optimizations, using a defaultdict for measurements
...
# Same as V4 but specifies to read the measurements file with read only and utf-8 encoding
#
